...
npx skills add proxxysa/proxxy.sa --list

# Install a specific skill
npx skills add proxxysa/proxxy.sa --skill stitch-design --global
```
...
```bash
npx skills add proxxysa/proxxy.sa --skill stitch-loop --global
```
...
```bash
npx skills add proxxysa/proxxy.sa --skill design-md --global
```
...
```bash
npx skills add proxxysa/proxxy.sa --skill enhance-prompt --global
```
...
```bash
npx skills add proxxysa/proxxy.sa --skill react-components --global
```
...
```bash
npx skills add proxxysa/proxxy.sa --skill remotion --global
```
...
```bash
npx skills add proxxysa/proxxy.sa --skill shadcn-ui --global
```

### taste-design
Design taste reference skill providing curated design system resources and visual language guidance.

```bash
npx skills add proxxysa/proxxy.sa --skill taste-design --global
```
